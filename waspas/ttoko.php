<?php 
	...
	if (isset($_POST["simpan"])) {
		...
		$ktoko = $_POST["kodetoko"]; foreach ($kriteria as $krite) {
			$kkrit = $krite["kodekrit"];
			ctoko($ktoko, $kkrit);	
		}
				...
				<div style="padding: 25px">
					...
					<div style="width: 95%">
						<form action="" method="post">
							<h5>Kode Toko</h5>
							<input type="text" name="kodetoko" class="form-control" placeholder="Masukan Kode Toko" autocomplete="off" style="width: 100%" required>
							<br>
							<h5>Nama Toko</h5>
							<input type="text" name="nama" class="form-control" placeholder="Masukan Nama Toko"  autocomplete="off"  style="width: 100%" required>
							<br>
							<h5>Alamat</h5>
							<input type="text" name="alamat" class="form-control" placeholder="Masukan Alamat Toko"  autocomplete="off"  style="width: 100%" required>
							<br>
