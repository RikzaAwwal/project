<?php 
	...
	if (isset($_POST["simpan"])) {
		...
		if ($_POST["atribut"] == "") {
			echo "
				<script>
					alert('Atribut Belum Diisi!'); 
					document.location.href = 'tkriteria.php';
				</script>
			";
		} else if (tkrit($_POST) > 0) {
			echo "
				<script>
				...
				<div style="padding: 25px">
					...
					<div style="width: 95%">
						<form action="" method="post">
							<h5>Kode Kriteria</h5>
							<input type="text" name="kodekrit" class="form-control" placeholder="Masukan Kode Toko" autocomplete="off" style="width: 100%" required>
							<br>
							<h5>Nama Kriteria</h5>
							<input type="text" name="nama" class="form-control" placeholder="Masukan Kode Toko"  autocomplete="off"  style="width: 100%" required>
							<br>
							<h5>Atribut</h5>
							...
							<br>
							<h5>Bobot</h5>
							<input type="text" name="bobot" class="form-control" placeholder="Masukan Kode Toko"  autocomplete="off"  style="width: 100%" required>
							<br>
