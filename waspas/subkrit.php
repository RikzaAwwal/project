			...
			<div style="background-color: white; margin: 25px; border-radius: 10px">
				<div style="padding: 25px">
					...
					<div style="float: right; margin-bottom: 10px">
						<a href="tsubkrit.php"><button class="btn btn-success">Tambah</button></a>
					</div>
							...
							<tr>
								<?php foreach ($subkriteria as $subkrit): ?>
									...
									<?php foreach ($z as $key): ?>
										...
										<td style="text-align: center;"><?= $key["nilai"]; ?></td>
										<td style="text-align: center; white-space: nowrap;">
											<a class="btn btn-info" href="usubkrit.php?id=<?= $subkrit['kodesub']; ?>">Edit</a>
											<a class="btn btn-danger" href="hsubkrit.php?id=<?= $subkrit['kodesub']; ?>">Hapus</a>
										</td>
							</tr>
									<?php $i++; endforeach ?>
								<?php endforeach ?>
